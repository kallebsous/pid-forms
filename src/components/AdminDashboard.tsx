            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-700">
                ...
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">Data de Inscrição</th>
            ...
            {isLoading ? (
                ...
                registrations.map((registration) => (
                    ...
                    >
                      ...
                      <p><strong>Data:</strong> {formatDate(registration.created_at)}</p>
